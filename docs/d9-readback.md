...
|---|---|---|---|---|
| 動手前 | 173 | 7 | 67 | beam 3、stairs 1、partition 7 |
...
| 2F「複製整層到 4F」（confirm 文字：「會先清掉 4F 的 9 件設備、7 個廁所／房間隔層，再把 2F 的 20 件設備、10 個廁所／房間隔層複製過去…」） | 175 | 20 | 68 | beam 3、stairs 1、**bath 2、partition 8**（跟 2F 一樣；梁樓梯不動）；總數 53 |
...
還原後：方案 4F 7 件、2F 20 件；結構總數 50、4F beam 3／stairs 1／bath 0／partition 7——跟動手前一致。

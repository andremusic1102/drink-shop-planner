...
ENTRY = {"id": "entry-1", "kind": "entry", "floor": 1, "name": "玄關 116×100", "x": 1184, "y": 0, "w": 116, "d": 100}   # 2026-09-18 定案：玄關線 1184
# ⚠ 2026-09-18：SX 把圖上 1219 硬拉成 1300 是錯的——爸實測 2F 室內淨長 1184，用 1184/400 換算才跟實測吻合
#   （廁所 A 起點正好 308）。1300 是 1F 到街面的長度，2F 的 1184 對應 CAD x=0–1184。重跑前先改 SX。
